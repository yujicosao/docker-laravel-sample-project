          ...
          <form method="POST" action="{{ route('contact.confirm') }}" class="contact-form">
            ...
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <input 
                  ...
                  value="{{ old('email') }}">
                  @if ($errors->has('email'))
                    <p class="error-message">{{ $error->first('email') }}</p>
                  @endif
              </div>
            </div>
            ...
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <input 
                  ...
                  value="{{ old('title') }}">
                  @if ($errors->has('title'))
                    <p class="error-message">{{ $error->first('title') }}</p>
                  @endif
              </div>
            </div>
            ...
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <textarea name="body" id="message" cols="30" rows="5" class="form-control" placeholder="お問い合わせ内容を記入してください">{{ old('body') }}</textarea>
                @if ($errors->has('body'))

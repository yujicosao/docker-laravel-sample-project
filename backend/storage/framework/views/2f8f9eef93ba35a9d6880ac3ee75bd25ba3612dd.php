<?php $__env->startSection('title', 'Apart TOPPAGE'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <div class="text">
            <h2>東京の天気</h2>
            <p class="mb-5">取得日時：<?php echo e($weather_info['weather_created_at']); ?></p>
            <img src="<?php echo e($weather_info['weather_image']); ?>" alt="">
            <p class="mb-5"><?php echo e($weather_info['weather_text']); ?></p>
            <p class="mb-5"><?php echo e($weather_info['weather_body']); ?></p>
        </div>
        </div>
    </div>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /work/resources/views/index.blade.php ENDPATH**/ ?>
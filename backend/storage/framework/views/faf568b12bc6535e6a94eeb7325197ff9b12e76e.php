<?php $__env->startSection('title', 'Apart Contact'); ?>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 col-lg-7 mb-5">
          ...
          <form method="POST" action="<?php echo e(route('contact.confirm')); ?>" class="contact-form">
              ...
              <div class="col-md-12">
                ...
                <input 
                  ...
                  <?php if($errors->has('email')): ?>
                    <p class="error-message"><?php echo e($error->first('email')); ?></p>
                  <?php endif; ?>
              </div>
            </div>
              ...
              <div class="col-md-12">
                ...
                <input 
                  ...
                  <?php if($errors->has('title')): ?>
                    <p class="error-message"><?php echo e($error->first('title')); ?></p>
                  <?php endif; ?>
              </div>
            </div>
            ...
            <div class="row form-group">
              <div class="col-md-12">
                <label class="font-weight-bold" for="body">お問い合わせ内容</label>
                <textarea name="body" id="message" cols="30" rows="5" class="form-control" placeholder="お問い合わせ内容を記入してください"><?php echo e(old('body')); ?></textarea>
                <?php if($errors->has('body')): ?>
                  <p class="error-message"><?php echo e($errors->first('body')); ?></p>
                <?php endif; ?>
              </div>
            </div>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /work/resources/views/contact/index.blade.php ENDPATH**/ ?>
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/mediaelementplayer.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/animate.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('fonts/flaticon/font/flaticon.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/fl-bigmug-line.css')); ?>">
  ...
  <div class="text-right">
    ...
    <?php else: ?>
    <?php echo e(Auth::user()->name); ?>様：ログイン中です
    <a href="<?php echo e(route('admin-news.index')); ?>" class="btn btn-primary">管理画面へ</a>
 ...
 <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
        ...
        <div class="container py-1">
          <div class="row align-items-center">
            <div class="col-8 col-md-8 col-lg-4">
              <h1 class="mb-0"><a href="<?php echo e(route('top')); ?>" class="text-white h2 mb-0"><strong>Apart<span class="text-primary">.</span></strong></a></h1>
            </div>
            <div class="col-4 col-md-4 col-lg-8">
              <nav class="site-navigation text-right text-md-right" role="navigation">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  <li class="active">
                    <a href="<?php echo e(route('top')); ?>">Home</a>
                  </li>
  ...
  <script src="<?php echo e(asset('js/circleaudioplayer.js')); ?>"></script>

  <script src="<?php echo e(asset('js/main.js')); ?>"></script>
  <script src="<?php echo e(asset('js/app.js')); ?> "></script>
  </body>
</html>
<?php /**PATH /work/resources/views/base.blade.php ENDPATH**/ ?>